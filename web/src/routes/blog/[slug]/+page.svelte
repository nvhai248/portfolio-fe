<script lang="ts">
	...
	const pageTitle = $derived(`${post.title} | Blog | Nguyen Van Hai`);
	const metaDescription = $derived(
		post.excerpt || `Read "${post.title}" by Nguyen Van Hai — technical insights on backend engineering, architecture, and AI integration.`
	);
	...
	<div class="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
		...
		<article class="lg:col-span-9 xl:col-span-8 xl:col-start-4">
			...
			<div class="mt-16 border-t ui-divider pt-8">
				<a class="ui-link text-sm" href="/blog">← Back to all posts</a>
			</div>
		</article>
	</div>
</div>
