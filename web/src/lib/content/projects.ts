import type { ProjectContent, SectionIntroContent } from '$lib/types/content';

export const projectsIntro: SectionIntroContent = {
	eyebrow: 'Projects',
	title:
...
export const projects: ProjectContent[] = [
	{
		...
		stack: 'PHP 8.2, Moodle plugin architecture, Redis, Ollama, REST APIs, Azure DevOps'
	},
	{
		...
		stack: 'Golang, Azure Functions, Qdrant, Docker, Kubernetes, PostgreSQL'
	},
	{
		...
		stack: 'PHP, PostgreSQL, Redis, API profiling tools, Azure monitoring stack'
	}
];
