		...
		tools: {
			...
			imageCompress: {
				...
				ui: {
					...
					dropTitle: 'Kéo ảnh vào đây hoặc chọn từ máy',
					dropDescription:
						'Ảnh được xử lý ngay trên trình duyệt. Tool sẽ tự giảm chất lượng và kích thước cho đến khi ảnh đầu ra nhỏ hơn <strong>1MB</strong>.',
					...
					note: 'Tool ưu tiên tạo file nhỏ hơn <strong>1MB</strong> mà vẫn giữ mức rõ nét tốt nhất có thể trong browser hiện tại.',
		...
		tools: {
			...
			imageCompress: {
				...
				ui: {
					...
					dropTitle: 'Drop an image here or choose one from your device',
					dropDescription:
						'Everything runs directly in your browser. The tool automatically reduces quality and dimensions until the output file is smaller than <strong>1MB</strong>.',
					chooseForCompression: 'Choose image to compress',
					...
					formatLabel: 'Format',
					qualityScaleLabel: 'Quality / Scale',
					note: 'The tool prioritizes creating a file under <strong>1MB</strong> while preserving as much clarity as possible in the current browser.',
