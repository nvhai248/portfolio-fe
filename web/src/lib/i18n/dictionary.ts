...
export const dictionary = {
	vi: {
		...
		tools: {
			...
			imageCompress: {
				title: 'Nén ảnh < 1MB',
				description: 'Nén ảnh JPEG, PNG hoặc WebP trực tiếp trên trình duyệt để tạo file mới nhỏ hơn 1MB.',
				back: 'Quay lại Công cụ',
				ui: {
					eyebrow: 'Image Compression',
					headline: 'Nén ảnh tự động xuống dưới 1MB',
					uploadImage: 'Tải ảnh lên',
					addMoreImages: 'Thêm ảnh',
					replaceImage: 'Chọn ảnh khác',
					recompress: 'Nén lại',
					recompressAll: 'Nén lại tất cả',
					recompressOne: 'Nén lại ảnh này',
					download: 'Tải ảnh mới',
					downloadAll: 'Tải tất cả ảnh',
					clearList: 'Xóa danh sách',
					targetChip: 'Mục tiêu < 1MB',
					processingChip: 'Đang nén ảnh...',
					processingQueueChip: 'Đang xử lý hàng đợi...',
					doneChip: 'Đã tạo file dưới 1MB',
					dropTitle: 'Kéo thả nhiều ảnh vào đây hoặc chọn từ máy',
					dropDescription:
						'Ảnh được xử lý ngay trên trình duyệt. Tool sẽ tự giảm chất lượng và kích thước cho từng ảnh cho đến khi file đầu ra nhỏ hơn <strong>1MB</strong>.',
					chooseForCompression: 'Chọn ảnh để nén',
					batchSummaryTitle: 'Tổng quan batch',
					totalImagesLabel: 'Tổng số ảnh',
					readyLabel: 'Sẵn sàng',
					failedLabel: 'Lỗi',
					downloadableLabel: 'Có thể tải',
					queueProgressLabel: 'Tiến độ hàng đợi',
					originalTitle: 'Ảnh gốc',
					originalEmpty: 'Ảnh gốc sẽ hiển thị tại đây sau khi bạn tải lên.',
					compressedTitle: 'Ảnh sau nén',
					processingBody: 'Đang tối ưu ảnh và kiểm tra kích thước đầu ra...',
					compressedEmpty: 'Bản nén sẽ hiển thị tại đây khi hoàn tất.',
					detailsTitle: 'Chi tiết đầu ra',
					originalSizeLabel: 'Dung lượng gốc',
					compressedSizeLabel: 'Dung lượng mới',
					savedLabel: 'Tiết kiệm',
					dimensionsLabel: 'Kích thước',
					formatLabel: 'Định dạng',
					qualityScaleLabel: 'Quality / Scale',
					note: 'Tool ưu tiên tạo từng file nhỏ hơn <strong>1MB</strong> mà vẫn giữ mức rõ nét tốt nhất có thể trong browser hiện tại.',
					status: {
						queued: 'Chờ xử lý',
						processing: 'Đang nén',
						done: 'Hoàn tất',
					...
					invalidFile: 'Vui lòng chọn một file hình ảnh hợp lệ.',
					unsupportedFilesNotice: 'Đã bỏ qua {count} file không phải hình ảnh hợp lệ.',
					decodeFailedNotice: 'Có {count} ảnh không thể đọc hoặc phân tích kích thước.',
					decodeFailed: 'Không thể đọc dữ liệu ảnh này trong trình duyệt hiện tại.',
					canvasUnavailable: 'Trình duyệt hiện tại không hỗ trợ xử lý canvas.',
					compressFailed: 'Không thể tạo ảnh mới dưới 1MB với file này.',
					browserFailed: 'Không thể nén ảnh trong browser hiện tại.'
				}
			},
			music: {
				title: 'Nghe nhạc',
	...
	en: {
		...
		tools: {
			...
			imageCompress: {
				title: 'Compress Image < 1MB',
				description: 'Compress JPEG, PNG or WebP images directly in the browser and generate a new file under 1MB.',
				back: 'Back to Tools',
				ui: {
					eyebrow: 'Image Compression',
					headline: 'Automatically compress images below 1MB',
					uploadImage: 'Upload image',
					addMoreImages: 'Add images',
					replaceImage: 'Choose another',
					recompress: 'Recompress',
					recompressAll: 'Recompress all',
					recompressOne: 'Recompress this image',
					download: 'Download new image',
					downloadAll: 'Download all images',
					clearList: 'Clear list',
					targetChip: 'Target < 1MB',
					processingChip: 'Compressing image...',
					processingQueueChip: 'Processing queue...',
					doneChip: 'Created a file under 1MB',
					dropTitle: 'Drop multiple images here or choose them from your device',
					dropDescription:
						'Everything runs directly in your browser. The tool automatically reduces quality and dimensions for each image until every output file is smaller than <strong>1MB</strong>.',
					chooseForCompression: 'Choose images to compress',
					batchSummaryTitle: 'Batch summary',
					totalImagesLabel: 'Total images',
					readyLabel: 'Ready',
					failedLabel: 'Failed',
					downloadableLabel: 'Downloadable',
					queueProgressLabel: 'Queue progress',
					originalTitle: 'Original image',
					originalEmpty: 'The original image preview will appear here after upload.',
					compressedTitle: 'Compressed image',
					processingBody: 'Optimizing image and validating the output size...',
					compressedEmpty: 'The compressed result will appear here when ready.',
					detailsTitle: 'Output details',
					originalSizeLabel: 'Original size',
					compressedSizeLabel: 'New size',
					savedLabel: 'Saved',
					dimensionsLabel: 'Dimensions',
					formatLabel: 'Format',
					qualityScaleLabel: 'Quality / Scale',
					note: 'The tool prioritizes keeping each file under <strong>1MB</strong> while preserving as much clarity as possible in the current browser.',
					status: {
						queued: 'Queued',
					...
					unsupportedFilesNotice: 'Skipped {count} files that were not valid images.',
					decodeFailedNotice: '{count} image files could not be decoded or measured.',
					decodeFailed: 'Could not decode this image in the current browser.',
					canvasUnavailable: 'Canvas processing is not available in this browser.',
					compressFailed: 'Could not produce a new image below 1MB for this file.',
					browserFailed: 'Could not compress this image in the current browser.'
				}
			},
			music: {
				title: 'Music Player',
